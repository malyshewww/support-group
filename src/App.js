...
import {
  imgDataForCartLanding,
  imgDataForCartMarket,
  imgDataForCartShop,
} from "./data/imgDataForCart";
import {
  imgDataForListLanding,
  imgDataForListMarket,
  imgDataForListShop,
} from "./data/imgDataForList";
  ...
  useEffect(() => {
    ...
    dataForLanding["Тип бизнеса"].forEach((el) => {
      ...
      if (
        ...
        sessionStorage.getItem(name).length > 2
      ) {
        ...
        <Route
          element={
            <CartPage
              ...
              removeObjectFromData={removeObjectFromData}
            />
          }
          path="/cart"
        />
